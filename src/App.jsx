...
const App = () => {
  ...
  window.sessionStorage.setItem("allMessages", JSON.stringify({
    "0": [{"from":"1","date":1697094148,"message":"There are 10 types of people: those who understand binary and those who don’t","roomId":"0"},{"from":"1","date":1697094348,"message":"","roomId":"0"},{"from":"3","date":1697094548,"message":"In a room full of top software designers, if two agree on same thing, that’s a majority.","roomId":"0"},{"from":"4","date":1700123793,"message":"There are two ways to write error-free programs; only the third one works.🍾","roomId":"1:4"}],
    "1:4": [{"from":"4","date":1697093948,"message":"boss make a dollar; I make a dime; that's why my algorithms run in exponential time","roomId":"0"},{"from":"4","date":1697094704,"message":"There are two ways to write error-free programs; only the third one works.🍾","roomId":"1:4"},{"from":"1","date":1697094746,"message":"A user interface is like a joke. If you have to explain it, it’s not that good 🍸","roomId":"1:4"}],
    "1:2": [{"from":"1","date":1697094746,"message":"A user interface is like a joke. If you have to explain it, it’s not that good 🍸","roomId":"0"},{"from":"1","date":1700127951,"message":"Before software can be reusable it first has to be usable🥑","roomId":"0"},{"from":"1","date":1700127958,"message":"If one programmer can do it in one week, then 2 programmers can do it in 2 weeks!","roomId":"0"},{"from":"2","date":1700126273,"message":"Programming is the art of adding bugs to an empty text file.","roomId":"1:2"}],
    ...
    "1:3": [{"from":"3","date":1697093948,"message":"The computer was born to solve problems that did not exist before.🧁","roomId":"1:3"},{"from":"1","date":1697094704,"message":"UNIX is user friendly. It’s just very particular about who its friends are.🧃","roomId":"1:3"}],
